...
Config.ParkingLocations = {
	...
	parking2 = {
		...
		height = 10.0,         -- The parking range radius (Vertical)
		name   = "Public Parking", -- The name of the parking (blips)
		fee    = 5,          -- How much parking fee per day (Real life time), set false to disable
	...
	parking3 = {
		...
		height = 10.0,         -- The parking range radius (Vertical)
		name   = "Public Parking", -- The name of the parking (blips)
		fee    = 8,          -- How much parking fee per day (Real life time), set false to disable
	...
	parking4 = {
		...
		height = 10.0,         -- The parking range radius (Vertical)
		name   = "Public Parking", -- The name of the parking (blips)
		fee    = 7,          -- How much parking fee per day (Real life time), set false to disable
